...
const NavBar = () => {
  ...
  const links = [
    { id: 1, name: 'Start', target: '#start' },
    { id: 2, name: 'Über mich', target: '#about' },
    { id: 3, name: 'Projekte', target: '#projects' },
  ];
  ...
  return (
    <div className="fixed flex items-center justify-between md:w-[80%] md:ml-[10%] h-20 px-4 text-white z-5 md:rounded-[30px] rounded-b-[30px] md:mt-[8px] navbar w-full">
      ...
      <div
        onClick={() => setNav(!nav)}
        className="z-10 pr-4 cursor-pointer text-zinc-100 md:hidden"
      >
        <div>
